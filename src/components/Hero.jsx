  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-[#F6FEDB]`}>
            Hi there, this is <span className="text-[#171D1C]">Samaanata</span>
          </h1>
          <p className={`${styles.heroSubText} mt-5 text-[#F6FEDB]`}>
            An AI Tool to
      ...
      <div className="absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center">
        <a href="#upload">
          <div className="w-[35px] h-[64px] rounded-3xl border-4 border-[#F6FEDB] flex justify-center items-start p-2">
            <motion.div
              animate={{ y: [0, 24, 0] }}
              transition={{ duration: 1.5, repeat: Infinity, repeatType: "loop" }}
              className="w-3 h-3 rounded-full bg-[#F6FEDB] mb-1"
            />
          </div>
        </a>
      </div>
